...
# DuckDuckGo search: xrandr custom resolution vmbox
# Example: sh customresvmbox.sh 1300 670 60
# Width Height MonitorFrequency
# Use case scenarios: Puppy Linux under Oracle VM VirtualBox (Windows x64)
